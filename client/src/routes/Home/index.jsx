            ...
            <div className="home-block-container">
                <div className="home-block">
                    <div className="home-block_info">
                        <h2 className="heading">Secure storage for your photos</h2>
                        <h4 className="description">Enable auto-upload on your phone and Yandex Disk will store all your photos in their original resolution.</h4>
